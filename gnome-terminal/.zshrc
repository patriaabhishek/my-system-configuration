...
__conda_setup="$('/home/abhishek/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/abhishek/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/abhishek/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/abhishek/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# Youtube Download
download_video() {
        echo "Starting video/playlist download using yt-dlp:\n"
